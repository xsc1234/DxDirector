...
import re
import logging
import my_transformers  # noqa: F401
import os
import json
from my_transformers import pipeline, set_seed
from my_transformers import AutoConfig, AutoTokenizer, AutoModelForCausalLM
...
if __name__ == "__main__":
    ...
    logging.getLogger("my_transformers").setLevel(logging.ERROR)

...
from my_transformers.modeling_utils import dtype_byte_size
from my_transformers.models.switch_transformers.convert_switch_transformers_original_flax_checkpoint_to_pytorch import (
    rename_keys,
)
from my_transformers.utils import WEIGHTS_INDEX_NAME, WEIGHTS_NAME
from my_transformers.utils.hub import convert_file_size_to_int
...
def sanity_check():
    from my_transformers import SwitchTransformersConfig, SwitchTransformersForConditionalGeneration, T5Tokenizer

...
TOKENIZER_CLASSES = {name: getattr(my_transformers, name + "Fast") for name in SLOW_TO_FAST_CONVERTERS}
...
def convert_slow_checkpoint_to_fast(tokenizer_name, checkpoint_name, dump_path, force_download):
    ...
    if tokenizer_name is None:
        ...
        tokenizer_names = {tokenizer_name: getattr(my_transformers, tokenizer_name + "Fast")}

...
# 获取上上上级目录
great_grandparent_dir = os.path.dirname(os.path.dirname(os.path.dirname(current_dir)))
# 将上上上级目录添加到 sys.path
...
def create_hf_model(model_class,
    ...
    # https://huggingface.co/docs/my_transformers/main_classes/deepspeed#nontrainer-deepspeed-integration
